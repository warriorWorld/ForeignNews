package com.warrior.hangsu.administrator.foreignnews.read;
...
public class ReadRichTextView extends TextView {
    ...
    public ReadRichTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public ReadRichTextView(Context context) {
        this(context, null);
    }
