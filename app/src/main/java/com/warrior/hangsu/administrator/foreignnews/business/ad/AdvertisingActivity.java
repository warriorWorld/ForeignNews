package com.warrior.hangsu.administrator.foreignnews.business.ad;
...
import com.warrior.hangsu.administrator.foreignnews.utils.ToastUtils;
        ...
        if (EasyPermissions.hasPermissions(this, perms)) {
            ...
            downloadFile.getDataInBackground(new GetDataCallback() {
                ...
                public void done(byte[] bytes, AVException e) {
                    ...
                    if (LeanCloundUtil.handleLeanResult(AdvertisingActivity.this, e)) {
                        File apkFile = FileUtil.byte2File(bytes, filePath, "english_ad.apk");
