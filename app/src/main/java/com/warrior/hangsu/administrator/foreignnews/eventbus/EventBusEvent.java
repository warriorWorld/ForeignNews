package com.warrior.hangsu.administrator.foreignnews.eventbus;/**
...
public class EventBusEvent {
    ...
    public static final int COPY_BOARD_URL_EVENT=22;
    public static final int COPY_BOARD_TEXT_EVENT=23;
    private String msg;
    private int intMsg;
