package com.warrior.hangsu.administrator.foreignnews.widget.dragview;
...
import com.warrior.hangsu.administrator.foreignnews.utils.VibratorUtil;
...
public class DragView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init() {
        ...
        marginBottom = DisplayUtil.dip2px(mContext, 50);
    }
